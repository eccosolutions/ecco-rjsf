// Originally from https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/@eccosolutions/rjsf-core/index.d.ts

declare module '@eccosolutions/rjsf-core' {
...
declare module '@eccosolutions/rjsf-core/lib/components/fields/SchemaField' {
    import { JSONSchema7 } from 'json-schema';
    import { FieldProps, UiSchema, IdSchema, FormValidation } from '@eccosolutions/rjsf-core';
...
declare module '@eccosolutions/rjsf-core/lib/validate' {
    import { JSONSchema7Definition } from 'json-schema';
    import { AjvError, ErrorSchema, FormProps } from '@eccosolutions/rjsf-core';
